...
@section('content')
    ...
    <div class='card'>
        <div class='card-body'>
            <form method="POST" id="idForm" action="/sales/cadastrar" enctype="multipart/form-data" role="form">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="cpf" name="cpf" placeholder="99999999999" maxlength="11">
                </div>
